...
delivery:{title:'Last-mile delivery',icon:'M2 6h12v12H2zM14 10h4l4 4v4h-8M7 18a2 2 0 1 0 0 .1M18 18a2 2 0 1 0 0 .1',intro:'From the wholesaler to your door with WOW-Go.',description:'Planned with WOW-Go: get stock delivered to your spaza through a South African, industry-owned network.',points:['Collection from participating supply points','Delivery to your spaza’s address through WOW-Go','Delivery costs and timing confirmed before you order'],note:'The spaza.coop and WOW-Go delivery integration is planned. Coverage, fees and delivery windows still need to be confirmed. Boxer’s current bulk service is collection-based.'}
};
